...
1. JS (official support) - `npx degit https://github.com/kissthebug/blog.git` or TS (community support) - `npx degit kissthebug/blog#typescript`
...
[MIT](https://github.com/kissthebug/blog/blob/main/LICENSE) © [Timothy Lin](https://www.timrlx.com)
